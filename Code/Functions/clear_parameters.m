...
% Reset GUI radio buttons, input fields, and other controls to default values
...
cla(S.ax(1));cla(S.ax(2)); % Clear axes 1 and 2

% Reset spike detection and plotting parameters
...
S.tabe2.Data=[];cla(S.ax(3));cla(S.ax(4));cla(S.ax(5));cla(S.ax(6));cla(S.ax(7)); % Clear axes 3-7
...
cla(S.ax(13));cla(S.ax(14));cla(S.ax(15)); % Clear axes 12-15

% Reset firing rate, ISI, and autocorrelation analysis parameters
...
subplot(1,1,1,'replace','Parent',S.ax(24)); % Clear axes 13-24 and reset subplots
