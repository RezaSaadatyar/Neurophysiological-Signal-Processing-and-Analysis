...
ax8.NextPlot = 'replaceall'; ax9.NextPlot = 'replaceall'; ax10.NextPlot = 'replaceall'; 
ax11.NextPlot = 'replaceall';
...
if get(diswave, 'value') == 1
    ...
    plot_features(spikes, waveletSpik, F1, F2, Feat33, F3, til, ax8, ax9, ax10, ax11, cm, S);
